    ...
    public class CrawlZingMp3: MainWindow
    {
        ...
        private string getURL(string id)
        {
            ...
            {               
                ...
                string stringResponse = request.GetAsync(link).ToString();
        ...
        private void Crawl()
        {
            ...
            string bodyHTML = request.GetAsync(@"mp3.zing.vn/zing-chart-tuan/bai-hat-Viet-Nam/IWZ9Z08I.html").ToString();
